...
import { ThemeProvider, createTheme, IconButton, Typography, Toolbar, Box, AppBar, Button } from "@mui/material";
   ...
   // no longer need render becuase it's going to be a functional component so its returning LogIn component
      ...
      return ( 
        ...
        <div className="container">
            ...
            <div>
            <Button
              variant="contained" color="primary" onClick={(e) =>handleLogOut(e)} type="submit"> 
              Sign Out
            </Button>
            </div>
            </Toolbar>
