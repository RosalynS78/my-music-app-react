...
<Card>
      <Box sx={{ width: 900, height: 300}}>
       ...
       {/* working on prev and next */}
          <IconButton checked={play.isPlaying} onClick={handlePlay} value={play} aria-label="play/pause" >
        ...
        <Typography m={10} sx={{ fontSize: 25 }} color="text.secondary" gutterBottom>
{notification.play}
</Typography>
<Typography m={10} sx={{ fontSize: 25 }} color="text.secondary" gutterBottom>
